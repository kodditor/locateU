...
export default function Admin()
{
    ...
    if ( !(isAuthenticated()) )
    {
        return (
            <>
                <Popup />
                <div className=" hidden md:flex w-[100vw] h-[100vh] justify-center items-center bg-white">  
                ...
                <div className="bg-white flex md:hidden justify-center w-[100vw] h-[100vh] py-4 text-center pt-10 text-black font-medium">
    ...
    else
    {
        ...
        if (verifyAdmin(user.email))
        {
            return (
                <>
                    <div className="hidden md:block bg-lightGrey">
                        <Header onlyLogo = {true} centered={true} />
                        <AdminDash user={user}/>
                        <Footer />
                    </div>

                    <div className=" bg-white flex md:hidden justify-center w-[100vw] h-[100vh] px-4 text-center pt-10 text-black font-medium">
                        <p>Please login with a laptop or desktop to access admin mode.</p>
                    </div>
                </>
            )
