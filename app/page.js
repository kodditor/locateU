  ...
  return (
    <main className="bg-white">
      <section className="bg-[url('/img/bbblurry.svg')] bg-no-repeat bg-center bg-contain bg-blend-lighten bg-opacity-20">
        <Header />
        <div className="flex flex-col items-center min-h-[620px]">
          ...
          <div>
              <form action="/search" className="flex flex-col items-center ">
                <div className="flex flex-row items-center justify-normal md:justify-between gap-2 md:gap-4 mb-5 md:mb-8 mx-2 w-full md:w-auto m-auto">
